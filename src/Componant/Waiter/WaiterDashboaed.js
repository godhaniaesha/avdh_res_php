      ...
      <div id={styles["a_main-content"]}>
        <div className={`container-fluid ${styles.a_main}`}>
          ...
          <div className={styles.a_category}>
            ...
            <div
              className={`owl-carousel owl-theme d-block a_categorySlider ${styles.a_categorySlider1}`}
            >
                ...
                <div className={`item ${styles.item}`} key={category.id}>
                  <div className={styles.a_slide}>
                    <div className={styles.a_img}>
                      <img
                        src={category?.categoryImage ? require(`${category.categoryImage}`) : ''}
                        alt={category.catName}
                      />
                    </div>
                    <p className={styles.catName}>{category.catName}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className={styles.a_dish}>
            ...
            <div
              className={`owl-carousel owl-theme a_dishSlider ${styles.a_dishSlider}`}
            >
              {dishesData.map((dish) => (
                <div className={`item ${styles.item}`} key={dish.id}>
                  <div className={styles.a_dslide}>
                    ...
                    <div
                      className={`${styles.a_price} d-flex justify-content-between`}
                    >
                      <p>{dish.price}</p>
                      <button>+</button>
                    </div>
